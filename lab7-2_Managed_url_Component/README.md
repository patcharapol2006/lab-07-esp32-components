...
- Lab 7-1: ใช้ local component (ในเครื่อง)
    ใช้ไฟล์ component ที่อยู่ในเครื่องของเรา เช่นในโฟลเดอร์ components/ ภายในโปรเจก

- Lab 7-2: ใช้ managed component จาก GitHub URL
    ดึง component จาก GitHub หรือแหล่งออนไลน์ผ่าน idf_component.yml โดยใช้ระบบ dependency management ของ ESP-IDF
